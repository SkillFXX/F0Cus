...
## Installation
You can download and compile the code yourself or download a pre-compiled version from the [Releases](https://github.com/SkillFXX/F0Cus/releases/) page.

*This software is designed exclusively for Windows and has only been tested on Windows 11.*
